...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for(int i=0;i<n;++i) {
            for (int j = 0; j <n; ++j) {
                System.out.print(String.valueOf(matriceDeAdiacenta[i][j]) + " ");
            }
            System.out.println();
        }
        ...
        Graph Dictionar = new Graph(matriceDeAdiacenta,n);

        if(Dictionar.getConexNumber()>1){
            System.out.println("Graful nu este conex");
        }
        else System.out.println("Graful este conex");
        System.out.println("Numar de Componnete conexe:"+Dictionar.getConexNumber());
        System.out.println("Componnete conexe:"+Dictionar.getConexComponents());
    }
}
